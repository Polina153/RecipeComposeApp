...
class RecipesRepositoryStub: RecipesRepository {
    ...
    companion object {
        ...
        fun getRecipeById(recipeId: Int): RecipeDto? {
            // собираем все рецепты из всех категорий и ищем по id
            return listOf(
                burgerRecipes   // здесь появятся и другие списки, когда добавите
